            ...
            <div class="max-w-6xl w-full grid md:grid-cols-2 gap-12 items-center">
                                ...
                                <div class="swiper-wrapper">
                                    ...
                                    <div class="swiper-slide">
                                        ...
                                        <div
                                            ...
                                            <video class="w-full h-48 object-cover" autoplay muted loop playsinline>
                                                <source src="{{ asset('videos/my_first_website.mp4') }}"
                                                    type="video/mp4">
                                            </video>
                                            ...
                                            <div class="p-5">
                                                ...
                                                <p class="text-gray-600 mb-4">
                                                    My very first website project where I started learning HTML, CSS,
                                                    and
                                                    JavaScript.
                                                    This project helped me understand responsive layouts and basic web
                                                    development
                                                    fundamentals.
                                                </p>
                                                ...
                                                <div class="flex flex-wrap gap-2 mb-5">
                                                    ...
                                                    <span
                                                        class="text-xs bg-blue-100 text-blue-600 px-2 py-1 rounded">CSS
                                                        & UI
                                                        Design</span>
                                                    <span
                                    ...
                                    <div class="swiper-slide">
                                        ...
                                        <div
                                            class="bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-2xl transition transform hover:-translate-y-2">
                                            <video class="w-full h-48 object-cover" autoplay muted loop playsinline>
                                                <source src="{{ asset('videos/website_assignment.mp4') }}"
                                                    type="video/mp4">
                                            </video>
                                            ...
                                            <div class="p-5">
                                                ...
                                                <p class="text-gray-600 mb-4">
                                                    A responsive website project showcasing modern UI design and web
                                                    development
                                                    features.
                                                </p>
                                                ...
                                                <div class="flex flex-wrap gap-2 mb-4">
                                                    <span
                                                        class="text-xs bg-gray-100 text-gray-600 px-2 py-1 rounded">HTML5</span>
                                                    <span
                                    ...
                                    <div class="swiper-slide">
                                        ...
                                        <div
                                            ...
                                            <div class="p-5">
                                                ...
                                                <p class="text-gray-600 mb-4">
                                                    A responsive computer hardware e-commerce website showcasing PC
                                                    parts,
                                                    accessories, and product listings built using Laravel and Tailwind
                                                    CSS.
                                                </p>

                                                <div class="flex flex-wrap gap-2 mb-4">
                                                    <span
                                                        class="text-xs bg-red-100 text-red-600 px-2 py-1 rounded">HTML5</span>
                                                    <span
                                                        class="text-xs bg-blue-100 text-blue-600 px-2 py-1 rounded">CSS
                                                        & UI
                                                        Design</span>
                                    ...
                                    <div class="swiper-slide">
                                        ...
                                        <div
                                            ...
                                            <div class="p-5">
                                                ...
                                                <p class="text-gray-600 mb-4">
                                                    A modern health and wellness e-commerce website featuring longevity
                                                    supplements,
                                                    healthy foods, wellness equipment, and educational resources. Built
                                                    with a
                                                    clean,
                                                    responsive design to provide an engaging shopping experience across
                                                    all devices.
                                                </p>
                                                ...
                                                <div class="flex flex-wrap gap-2 mb-4">
                                                    <span
                                                        class="text-xs bg-red-100 text-red-600 px-2 py-1 rounded">HTML5</span>
                                                    <span
                                                        class="text-xs bg-blue-100 text-blue-600 px-2 py-1 rounded">CSS3</span>
                                                    <span
                                                        class="text-xs bg-yellow-100 text-yellow-600 px-2 py-1 rounded">JavaScript</span>
                                                    <span
                                                        class="text-xs bg-purple-100 text-purple-600 px-2 py-1 rounded">Bootstrap
                                                        5</span>
                                                    <span
                                                        class="text-xs bg-green-100 text-green-600 px-2 py-1 rounded">GoHighLevel</span>
                                                </div>

                                                <a href="https://github.com/SofiaMay26/longevity-website-2026"
                                                    target="_blank"
                                                    class="block text-center bg-blue-600 text-white py-2 rounded-lg hover:bg-blue-700 transition">
                                                    View Project
                                                </a>
                ...
                <section id="contact" class="py-20 bg-white">
                    <div class="max-w-4xl mx-auto px-6 text-center">
                        ...
                        <div class="mt-10">
                            <a href="https://mail.google.com/mail/?view=cm&fs=1&to=tempsofiemae@gmail.com"
                                target="_blank"
